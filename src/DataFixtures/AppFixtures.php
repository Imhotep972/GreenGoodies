...
{           
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $product->setDescription("Ce kit d’hygiène recyclable réunit l’essentiel pour une routine plus naturelle et respectueuse de l’environnement. Chaque accessoire est conçu pour réduire les déchets tout en offrant une expérience de soin agréable et efficace au quotidien.
...
Avec sa texture fluide et son goût tropical vibrant, ce shot devient un geste bien‑être simple et quotidien. Léger, naturel et sans additifs, il hydrate, dynamise et apporte un véritable coup de soleil à la journée.");
        ...
        $product->setDescription("Cette gourde élégante associe la chaleur du bois d’olivier à une conception moderne pensée pour un usage quotidien. Chaque pièce est unique grâce à ses veinures naturelles, offrant un design authentique et intemporel.
...
Pensée pour réduire l’usage du plastique, cette gourde devient un geste éco‑responsable au quotidien. Agréable en main et durable, elle allie style, praticité et engagement pour un mode de vie plus respectueux de l’environnement.");
        ...
        $product->setDescription("Ces disques réutilisables offrent une alternative douce et écologique aux cotons jetables. Leur texture moelleuse glisse facilement sur la peau pour un démaquillage efficace sans irritation.
...
Lavables et conçus pour durer, ces disques s’intègrent facilement dans une routine beauté responsable. Légers, pratiques et agréables à utiliser, ils deviennent rapidement un indispensable pour un soin quotidien plus sain et plus respectueux de l’environnement.");
        ...
        $product->setDescription("Cette bougie associe la douceur apaisante de la lavande aux notes profondes et boisées du patchouli. Sa cire naturelle diffuse une lumière chaleureuse et une fragrance délicate, idéale pour instaurer une atmosphère calme et réconfortante.
...
Conçue pour offrir une combustion propre et durable, cette bougie devient un véritable rituel bien‑être. Élégante, naturelle et agréable au quotidien, elle transforme chaque moment en parenthèse de douceur.");
        ...
        $product->setDescription("Cette brosse à dents en bois de hêtre rouge offre une alternative naturelle, élégante et durable aux modèles en plastique. Sa forme ergonomique et sa texture douce assurent une prise en main confortable pour un brossage agréable au quotidien.
...
Solide, esthétique et éco‑responsable, elle s’intègre parfaitement dans une routine d’hygiène plus consciente. Réduire les déchets devient un geste simple, tout en apportant une touche naturelle et chaleureuse à la salle de bain.");
        ...
        $product->setDescription("Ce kit de couverts en bois offre une alternative naturelle et élégante aux ustensiles jetables. Leur revêtement bio en olivier apporte une texture douce et agréable, idéale pour savourer chaque repas avec plus d’authenticité.
